(function () {
  ...
  function buildBanner() {
    ...
    el.innerHTML =
      '<div class="tcc-inner">' +
        '<p class="tcc-text"><strong>We use cookies.</strong> FreemiumPDF uses cookies for basic site functionality and, if you agree, to show relevant ads. See our <a href="/privacy-policy.html">Privacy Policy</a> for details.</p>' +
